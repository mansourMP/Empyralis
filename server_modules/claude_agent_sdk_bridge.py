...
def _humanize_tool_progress(tool_name: str) -> str:
    ...
    Originally from direct_chat_generation_service._humanize_tool_progress —
    moved here to remove the bridge's dependency on the legacy harness.
    """
    _map: dict[str, str] = {
...
def _tool_timeout_seconds(connector_id: str, action_id: str = "") -> float:
    ...
    Originally from direct_chat_generation_service._tool_timeout_seconds —
    moved here to remove the bridge's dependency on the legacy harness.
    """
