...
PREVIEW_MARKETPLACE_PACKAGES: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "kind": "skill",
        "label": "Web Search",
        "description": "Lets the agent search the web with audit-visible tool calls and governed usage.",
        "category": "Tool",
        "publisher": {"publisher_id": "empyralis", "label": "Empyralis", "website": "https://empyralis.dev"},
        "onboarding": {"docs_url": "/docs/studio-marketplace-ux-boundary-2026-04-30.md"},
        "verification_status": "verified",
    ...
    },
    {
        ...
        "kind": "connector",
        "label": "MCP Server",
        "description": "Connect a reviewed Model Context Protocol server so the agent can use approved external tools.",
        "category": "MCP",
        "publisher": {"publisher_id": "empyralis", "label": "Empyralis", "website": "https://empyralis.dev"},
