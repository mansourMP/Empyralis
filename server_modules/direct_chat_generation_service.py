...
# ── Live event sink (extracted to generation_event_sink.py) ──────────────────
from server_modules.generation_event_sink import _GENERATION_EVENT_SINK, wrap_generation_with_sink  # noqa: F401 — re-exported for backward compatibility
