...
export const DESIGN_SYSTEM_WEB_CSS_VARIABLES = {
  ...
  light: {
    ...
    // Accent single-sources to CSS (theme-tokens.css --accent). These inline
    // values pass through so the JS theme layer no longer competes with CSS
    // for the accent — change the hue once, in theme-tokens.css.
    '--app-border-accent': 'var(--accent-ring)',
    ...
    '--app-accent-primary': 'var(--accent)',
    '--app-accent-strong': 'var(--accent-strong)',
    '--app-accent-muted': 'var(--accent-muted)',
    '--app-accent-soft': 'var(--accent-soft)',
    '--app-accent-text': 'var(--accent-contrast)',
